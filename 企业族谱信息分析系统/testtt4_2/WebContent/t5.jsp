...
<img src="logo.png" style="margin-top: 0; margin-left: 0"
	...
	<div style="background-color: #ABF;">
		...
		<a  style="color:black;margin-left:50px;margin-right:50px;font-size:20px; text-decoration: none;" href="t3.jsp?content=<%=cname%>">查看投资族谱</a>
