...
from sql_read import id
from sql_read import name
from sql_read import explain
from sql_write import write
...
class Summary():
    ...
    def delStopwords(self,dict):
        sw_file = codecs.open('stopwords.txt',encoding='utf-8')
        stop_words = []
...
if __name__=='__main__':
    ...
    for i in id:
        print(i)
        summary = Summary()
        summary.main(name[j],explain[j],i)
        j=j+1